...
You cannot access this page! This is for only {{$restrict}}
</div>
...
<h1>You are not allowed to enter here. <br>You cannot access this page! This is for only {{$restrict}}</h1>
<h2>Go <a href="{{URL::to('/')}}" alt="Home" title="Home">Home!</a></h2>
<style>
